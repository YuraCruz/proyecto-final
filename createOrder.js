...
module.exports.handler = async (event) => {
    ...
    const params = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/071953601363/order-queue' // Reemplaza con tu URL de la cola
    };
    ...
    try {
        ...
        const emailParams = {
            Destination: {
                ToAddresses: ['Sebastiantrejos038@gmail.com'] // Reemplaza con la dirección de correo electrónico del destinatario verificado
            },
            Message: {
                Body: {
                    Text: {
            ...
            Source: 'leyutrecruz@gmail.com' // Reemplaza con tu dirección de correo electrónico de origen verificada
        };
